...
-   Qualquer outro nome, tipo **package utils**, **package math**, é um pacote reutilizável, ou seja, código que pode ser usado em outros lugares como se fosse uma dependência.

...
<img src='/icons/posts/go.svg' className='size-35 md:size-45 mx-auto'/>
...
- Com __&variavel__ pegamos o endereço de memória onde o valor dessa variável está guardado.
- Com __*ponteiro__ acessamos o valor que está nesse endereço (ou seja, o valor para o qual o ponteiro aponta).

...
para mais informações sobre **Hooks** -> [Documentação Fastify - Hooks](https://fastify.dev/docs/latest/Reference/Hooks/)
...
Para mais informações sobre **Decorators** -> [Documentação Fastify - Decorators](https://fastify.dev/docs/latest/Reference/Decorators/)

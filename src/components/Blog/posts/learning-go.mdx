...
Faz um tempo que eu tô de olho na linguagem GO, e finalmente tomei coragem p/ estudar, utilizei 2 cursos para iniciar os estudos, caso tenham interesse foram:

- Go: The Complete Developer's Guide do Stephen Grider
- Complete Go for Professional Developers pela FrontendMasters

<span className='italic text-xs text-neutral-500'>Dica: se vc tem uma conta estudante no github, tem acesso a 6 meses gratis nos cursos da FrontendMasters</span>	

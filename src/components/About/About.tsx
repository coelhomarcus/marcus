        ...
        <main className="text-white">
            ...
            <div className="flex justify-center mb-4 gap-4">
                <Link
                    ...
                    className="group flex items-center justify-center gap-1 vw-fit text-xs text-neutral-300 border border-neutral-800 hover:border-neutral-700/30 hover:bg-gradient-to-b hover:from-neutral-950 hover:to-neutral-900/50 p-1 text-center transition-all duration-200"
                >
                    <div className="w-fit border border-neutral-800 group-hover:border-transparent p-1 px-2 mr-1 text-center transition-all duration-400">
            ...
            {arrWorks.map((work) => (
                <div className="flex flex-col sm:flex-row gap-2 justify-between sm:items-center" key={work.company}>
                    <div className="flex gap-2 flex-col sm:flex-row">
                        <img src={work.logo} alt={work.company} className="size-6 sm:size-10 object-cover rounded-xs" />
                        <span>
                            <h3>{work.company}</h3>

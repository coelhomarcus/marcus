  ...
  return (
    <div className="text-white">
      ...
      <p className="text-neutral-400 text-base mb-4">
        Olá, me chamo Marcus Coelho, sou estudante de Sistemas de Informação na
        Unifesspa. Se quiser saber mais sobre minha trajetória,{" "}
        <span>
          <a
        ...
        <br />
        <br />
        Gosto de criar sites bonitos, acessíveis e fáceis de usar. No dia a dia,
        trabalho com o ecossistema{" "}
        <span className="text-neutral-300">React</span>, utilizando
        principalmente{" "}
        <span className="text-neutral-300">
          Vite/Next.js, Tailwind e TypeScript.
        </span>{" "}
        Estou sempre buscando evoluir como desenvolvedor — no momento estou me
        aprofundando em back-end com{" "}
        <span className="text-neutral-300">Node.js e Go</span>.
        <br />
        <br />
        Atualmente, faço parte da Exception Jr, uma empresa júnior da faculdade,
        onde atuo como Full Stack Developer. Alguns dos{" "}
        <Link
          className="transition-colors text-neutral-100 hover:underline"
          to="/projects"
        >

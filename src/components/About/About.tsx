        ...
        <main className="text-white">
            ...
            <div className="flex justify-center mb-4 gap-4">
                <Link
                    ...
                    className="group flex items-center justify-center gap-1 vw-fit text-xs text-neutral-300 border border-neutral-800 hover:border-neutral-700/30 hover:bg-gradient-to-b hover:from-neutral-950 hover:to-neutral-900/50 p-1 text-center rounded-sm transition-all duration-200"
                >
                    <div className="w-fit border border-neutral-800 group-hover:border-transparent p-1 px-2 mr-1 text-center rounded-sm transition-all duration-400">
